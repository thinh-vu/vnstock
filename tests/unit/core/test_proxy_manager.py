...
class TestProxyClass:
    ...
    def test_proxy_creation(self):
        ...
        proxy = Proxy(
            protocol="http", ip="192.168.1.1", port=8080, country="US", speed=50.0
        )
    ...
    def test_proxy_str(self):
        ...
        proxy = Proxy(protocol="socks5", ip="1.2.3.4", port=1080)
