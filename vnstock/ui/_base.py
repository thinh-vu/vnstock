...
class BaseUI:
    ...
    def _dispatch(self, domain_name: str, method_name: str, *args, **kwargs) -> Any:
        ...
        if domain_name in MAP and method_name in MAP[domain_name]:
            ...
            if isinstance(meta, dict) and args:
                ...
                if actual_method in meta:
                    ...
                    raise AttributeError(f"Method '{actual_method}' not found in sub-domain '{method_name}' of '{domain_name}'")
            ...
            try:
                ...
                raise AttributeError(f"Invalid registry entry for '{domain_name}.{method_name}'. Got: {meta}")
            ...
            layer_map = {
                'company': 'reference', 'listing': 'reference', 'fund': 'reference',
                'equity_market': 'market', 'equity_fundamental': 'fundamental',
                'misc': 'misc', 'dnse': 'broker'
            }
            ...
            if module_type == 'api':
                ...
                if class_name:
                    ...
                    init_kwargs = {}
                    for param in ['symbol', 'symbol_id', 'source', 'random_agent', 'show_log']:
        ...
        raise AttributeError(f"Method '{method_name}' not implemented for domain '{domain_name}'")
