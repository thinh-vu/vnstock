...
class DNSEBroker(BaseUI):
    ...
    def loan_packages(
        ...
        return self._dispatch(
            "dnse", "loan_packages", sub_account=sub_account, asset_type=asset_type
        )
    ...
    def order_list(
        ...
        """List all orders."""
        return self._dispatch(
            "dnse", "order_list", sub_account=sub_account, asset_type=asset_type
        )
    ...
    def deals_list(
        ...
        """List all deals."""
        return self._dispatch(
            "dnse", "deals_list", sub_account=sub_account, asset_type=asset_type
        )
