...
class QuoteProvider(Protocol):
    ...
    def intraday(self, symbol: str, page_size: int = 100, **kwargs) -> pd.DataFrame:
        """
...
class CompanyProvider(Protocol):
    ...
    def shareholders(self, symbol: str, page_size: int = 100, **kwargs) -> pd.DataFrame:
        """
...
class FinancialProvider(Protocol):
    ...
    def cash_flow(self, symbol: str, period: str = "quarter", **kwargs) -> pd.DataFrame:
        """
...
class ScreenerProvider(Protocol):
    ...
    def screen(self, criteria: Dict[str, Any], **kwargs) -> pd.DataFrame:
        """
